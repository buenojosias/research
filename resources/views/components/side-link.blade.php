...
@php
    $classes =
        $active ?? false
            ? 'my-1.5 text-base text-gray-900 font-normal rounded bg-slate-200 hover:bg-slate-400 hover:text-gray-100 group transition duration-75 flex items-center p-2 w-full'
    ...
    <li>
        <a href="{{ $href }}" {{ $attributes->merge(['class' => $classes]) }}>
            <svg aria-hidden="true"
                class="mr-3 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"

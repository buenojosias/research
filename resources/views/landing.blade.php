...
<head>
    ...
    <title>AnaliQ - Análises bibliométricas de monografias</title>
            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                <div class="flex lg:flex-1">
                    <a href="#" class="-m-1.5 p-1.5">
                        <span class="sr-only">Analiq</span>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                ...
                <div class="text-center">
                    <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Análises bibliométricas de
                        monografias</h1>
                    <p class="mt-6 text-lg leading-8 text-gray-600">Analise TCCs, dissertações, teses, científicos e
                        periódicos.</p>
